...
(function () {
    try {
        console.debug('Modal script: init');
        ...
        console.debug('Modal elements found:', {
        ...
        if (!modalBackdrop) {
            console.warn('Modal backdrop not found; skipping modal init');
            return;
        }

        function openModal() {
            console.debug('Modal script: openModal');
        ...
        function closeModal() {
            console.debug('Modal script: closeModal');
        ...
        if (!openers || openers.length === 0) {
            console.warn('No elements with [data-open-form] found');
        } else {
            openers.forEach(el => {
        ...
        console.error('Modal script initialization error:', err);
    }
})();
